...
# hdp-cli sound-run -m target/dev/hdp_provable_eth_call_executable.compiled_contract_class.json --print_output --cairo_pie ./pie.zip


#? If you're feeling brave (probably need like 500GB of RAM, for sure more than 70GB):
# hdp-cli sound-run -m target/dev/hdp_provable_eth_call_executable.compiled_contract_class.json --print_output --proof_mode --stwo_proof ./proof.json