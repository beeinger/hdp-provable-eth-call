...
mod tests {
    ...
    use crate::evm::instructions::SystemOperationsTrait;
    use crate::evm::memory::MemoryTrait;
    use crate::evm::precompiles::sha256::Sha256;
    use crate::evm::stack::StackTrait;
    use crate::evm::test_utils::{MemoryTestUtilsTrait, VMBuilderTrait, native_token};
    use crate::utils::traits::bytes::{FromBytes, ToBytes};
