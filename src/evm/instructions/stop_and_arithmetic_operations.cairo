...
use crate::utils::math::{Exponentiation, WrappingExponentiation, u256_wide_add};
use crate::utils::traits::integer::BytesUsedTrait;
...
mod tests {
    ...
    use crate::evm::instructions::StopAndArithmeticOperationsTrait;
