...
pub impl _impl of TxEip1559Trait {
    ...
    fn decode_fields(ref data: Span<RLPItem>) -> Result<TxEip1559, EthTransactionError> {
        ...
        let max_priority_fee_per_gas = RLPErrorTrait::map_err(
            max_priority_fee_per_gas_encoded.parse_u128_from_string(),
        )?;
        let max_fee_per_gas = RLPErrorTrait::map_err(
            max_fee_per_gas_encoded.parse_u128_from_string(),
        )?;
        ...
        let access_list = RLPErrorTrait::map_err(access_list_encoded.parse_access_list())?;
