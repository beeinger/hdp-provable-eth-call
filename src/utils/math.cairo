...
use core::num::traits::{BitSize, One, OverflowingAdd, OverflowingMul, Zero};
...
mod tests {
    use core::integer::u512;
    use core::num::traits::{Bounded, OverflowingMul, SaturatingAdd, WrappingMul};
    use crate::utils::math::{
        Bitshift, Exponentiation, WrappingBitshift, WrappingExponentiation, u256_wide_add,
    };
