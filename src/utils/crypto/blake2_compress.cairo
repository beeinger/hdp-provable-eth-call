...
use crate::utils::math::WrappingBitshift;
...
fn SIGMA() -> Span<Span<usize>> {
    [
        SIGMA_LINE_1.span(), SIGMA_LINE_2.span(), SIGMA_LINE_3.span(), SIGMA_LINE_4.span(),
        SIGMA_LINE_5.span(), SIGMA_LINE_6.span(), SIGMA_LINE_7.span(), SIGMA_LINE_8.span(),
        SIGMA_LINE_9.span(), SIGMA_LINE_10.span(),
    ]
        .span()
}
