...
use core::num::traits::{OverflowingAdd, OverflowingSub, WideMul, WrappingMul};
use core::option::OptionTrait;
use crate::utils::alexandria_data_structures::{Felt252Vec, Felt252VecImpl};
use crate::utils::felt_vec::Felt252VecTrait;
use crate::utils::helpers::u128_split;
use crate::utils::math::{Bitshift, WrappingBitshift};
use crate::utils::traits::BoolIntoNumeric;
use crate::utils::traits::integer::U128Trait;
use super::mpnat::{BASE, DOUBLE_WORD_MAX, DoubleWord, MPNat, WORD_BITS, WORD_MAX, Word};
...
mod tests {
    ...
    use crate::utils::alexandria_data_structures::{Felt252Vec, Felt252VecImpl, VecTrait};
    use crate::utils::crypto::modexp::arith::{
        big_sq, big_wrapping_mul, big_wrapping_pow, borrowing_sub, compute_r_mod_n, in_place_shl,
        in_place_shr, mod_inv, monpro, monsq, shifted_carrying_mul,
    };
    use crate::utils::crypto::modexp::mpnat::{
        BASE, DOUBLE_WORD_MAX, MPNat, MPNatTrait, WORD_BYTES, WORD_MAX, Word, mp_nat_to_u128,
    };
    use crate::utils::felt_vec::Felt252VecTrait;
    use crate::utils::math::{WrappingBitshift, WrappingExponentiation};
    ...
    fn test_big_wrapping_pow_4() {
        let expected_bytes: Span<u8> = [
            3, 218, 116, 252, 230, 21, 167, 46, 59, 185, 199, 194, 149, 140, 133, 157, 60, 102, 160,
            27, 104, 79, 16, 104, 20, 104, 116, 207, 214, 100, 237, 159, 0, 245, 249, 156, 52, 33,
            217, 113, 130, 6, 65, 78, 49, 141, 141, 160, 29, 125, 168, 236, 88, 174, 146, 81, 137,
            165, 242, 90, 251, 115, 144, 169, 141, 66, 207, 230, 56, 199, 140, 109, 7, 99, 35, 155,
            88, 29, 90, 192, 55, 127, 112, 26, 176, 181, 13, 72, 107, 209, 1, 210, 88, 233, 185, 87,
            108, 122, 168, 137, 255, 36, 201, 185, 31, 36, 51, 208, 64, 154, 113, 233, 71, 95, 35,
            253, 0, 3, 159, 183, 10, 83, 233, 88, 96, 19, 104, 229, 132, 73, 219, 152, 126, 215,
            249, 46, 110, 157, 234, 2, 100, 178, 150, 110, 217, 246, 128, 219, 121, 21, 234, 55,
            101, 81, 207, 191, 200, 201, 2, 40, 13, 80, 107, 226, 143, 164, 254, 91, 54, 46, 254, 7,
            14, 136, 149, 194, 6, 191, 14, 49, 140, 193, 40, 1, 138, 165, 82, 34, 33, 169, 41, 136,
            130, 47, 84, 173, 58, 121, 192, 247, 98, 237, 165, 215, 161, 198, 87, 228, 76, 160, 66,
            78, 169, 139, 234, 169, 83, 15, 16, 192, 170, 71, 227, 232, 116, 189, 81, 64, 104, 182,
